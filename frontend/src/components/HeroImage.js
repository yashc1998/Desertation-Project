...
const HeroImage = () => {
  return (
    <div
      className="header mx-auto px-6 md:px-12 relative z-10 flex items-center py-24 xl:py-40 bg-indigo-900"
      style={{ height: "30rem", zIndex: "-1" }}
    >
      <div className="lg:w-3/5 xl:w-2/5 flex flex-col items-start relative z-10">
        ...
        <div className="max-w-md">
          <p className="font-source-sans-pro text-white mt-6 text-lg">
            Your Gateway to Knowledge and Growth. Discover a world of online
            learning at your fingertips. Explore expert-led courses, gain
            valuable skills, and unlock your potential. Start your learning
            journey today
          </p>
        </div>
